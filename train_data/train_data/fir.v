...
module fir (
	...
	parameter dw = 18; parameter N = 14;
	parameter N_UNIQ = 7; localparam N_VALID_REGS = 19;

	input clk;
	input reset;
	input clk_ena;
	input i_valid;
	input [dw-1:0] i_in; output o_valid;
	output [dw-1:0] o_out; localparam dw_add_int = 18; localparam dw_mult_int = 36; localparam scale_factor = 17; localparam N_INPUT_REGS = 14;
	...
	input_pipeline in_pipe(
		...
		.reset(reset)	);
	defparam in_pipe.WIDTH = 18; wire [dw-1:0] L0_output_wires_0;
