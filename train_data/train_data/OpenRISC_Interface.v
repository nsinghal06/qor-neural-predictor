...
module OpenRISC_Interface(
   ...
   output reg[7:0]  openRISC_RSTN,	   output reg[7:0]  openRISC_STALL,	   output reg[7:0]	openRISC_ram_we,   output reg[15:0] openRISC_ram_addr, output 	 [31:0]	openRISC_data_o,
...
always@*begin
	...
	case(cur_st)
		...
		st_ready: begin
			delay_cnt_en = 1'b1;
			if(delay_cnt > 16'd20) begin _SDK_FIFO_RD = 1'b1;
