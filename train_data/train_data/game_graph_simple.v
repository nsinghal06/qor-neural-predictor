...
module game_graph_simple
   ...
   begin
      bar_y_next = bar_y_reg; if (refr_tick)
   ...
   assign ball_rgb = 3'b100;   assign ball_x_next = (refr_tick) ? ball_x_reg+x_delta_reg :
                        ball_x_reg ;
   ...
   begin
      ...
      if (ball_y_t < 1) y_delta_next = BALL_V_P;
