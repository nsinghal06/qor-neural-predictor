...
module apu_mixer
(
  input  wire       clk_in,       input  wire       rst_in,       input  wire [3:0] mute_in,      input  wire [3:0] pulse0_in,    input  wire [3:0] pulse1_in,    input  wire [3:0] triangle_in,  input  wire [3:0] noise_in,     output wire       audio_out,     output wire [5:0] dac_audio_out
);
